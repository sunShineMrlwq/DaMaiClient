...
public class UserManager extends Observable  {
    ...
    */
    ...
    public void fetchUserInfoByClientId(final String clientId, final IAnSocialCallback iAnSocialCallback,
                                        final  AddFriendsrCallback addFriendsrCallback){
            ...
            anSocial.sendRequest(WebInterface.fetchUserInfoByClientId(), AnSocialMethod.GET, params, new IAnSocialCallback(){
                ...
                public void onSuccess(final JSONObject arg0) {
                    ...
                    try {
                        ...
                        us= new User(userJson);
                        saveUser(us);
                    } catch (JSONException e) {
                        e.printStackTrace();
                    }
                    if(iAnSocialCallback!=null){
                        iAnSocialCallback.onSuccess(arg0);
                    }
                    if(addFriendsrCallback!=null){
                        addFriendsrCallback.onFinish(us);
                    }
                }
            });
        } catch (ArrownockException e) {
     ...
     * */
    public void addFriendRemote(final User targetUser, final  AddFriendsrCallback addFriendsrCallback){
        final Map<String, Object> params = new HashMap<String, Object>();
        ...
        try {
            anSocial.sendRequest(WebInterface.addFriendRemote(), AnSocialMethod.POST, params, new IAnSocialCallback(){
                ...
                public void onSuccess(final JSONObject arg0) {
                    ...
                    saveUser(targetUser);
                    if(addFriendsrCallback!=null){
                        addFriendsrCallback.onFinish(targetUser);
                    }
                }
            });
        } catch (ArrownockException e) {
...
//                    addFriendRemote(targetUser,null);
                    if(cbk!=null){
                        cbk.onSuccess(arg0);
                    }
                }
...
//                            }
    ...
    public void saveUser(User user){
        if((user.userId==null || user.userName==null) && user.clientId!=null){
            fetchUserInfoByClientId(user.clientId,null,null);
        }
    ...
    public interface AddFriendsrCallback{//haoyou
        public void onFinish(User user);
    }
}